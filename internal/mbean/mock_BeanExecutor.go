...
// Execute provides a mock function with given fields: env, operation
func (_m *MockBeanExecutor) Execute(env *jnigi.Env, operation MBeanOperation) (interface{}, error) {
	ret := _m.Called(env, operation)

	var r0 interface{}
	if rf, ok := ret.Get(0).(func(*jnigi.Env, MBeanOperation) interface{}); ok {
		r0 = rf(env, operation)
	} else {
		if ret.Get(0) != nil {
	...
	var r1 error
	if rf, ok := ret.Get(1).(func(*jnigi.Env, MBeanOperation) error); ok {
		r1 = rf(env, operation)
	} else {
		r1 = ret.Error(1)
	}
